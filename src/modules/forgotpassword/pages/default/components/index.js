        ...
        <div className="row">
            <div className="col-xs-12 col-md-6">
                <form className={styles.container} onSubmit={formik.handleSubmit}>
                    <Loading open={load} />
                    {data && data.otpConfigLoyalty.otp_enable[0].enable_otp_forgot_password && (
                        <FormControlLabel
                    ...
                    {data && data.otpConfigLoyalty.otp_enable[0].enable_otp_forgot_password && !useEmail && (
                        <OtpBlock
                    ...
                    <Button
                        disabled={data && data.otpConfigLoyalty.otp_enable[0].enable_otp_forgot_password && (disabled || load)}
