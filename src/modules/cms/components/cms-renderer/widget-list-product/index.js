...
import { generateQueriesCustom } from '@core_modules/cms/helpers/getProductListConditionsCustom';
...
const WidgetListProduct = (props) => {
    ...
    const dataFilter = generateQueriesCustom(template, dataConditions);
