/* eslint-disable consistent-return, no-tabs */
                                    ...
                                    <div className="row center-xs start-sm">
                                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <TextField
                                                ...
                                                value={formikPhoneEmail.values.email}
                                                onChange={formikPhoneEmail.handleChange}
                                                error={!!formikPhoneEmail.errors.email}
                                                errorMessage={formikPhoneEmail.errors.email || null}
                                            />
                                        </div>
                                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <PasswordField
